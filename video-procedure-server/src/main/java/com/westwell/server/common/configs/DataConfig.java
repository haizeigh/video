...
public class DataConfig {
    ...
    public static String TASK_START_TIME = "2021-02-01 00:00:00";

    public static String TASK_END_TIME = "2021-02-01 00:00:10";

    public static Integer FRAME = 10;
    ...
    public static double MIN_SIMILARITY = 0.8;
